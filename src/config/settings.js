export default {
  ...
  windows: [ // Array of windows to be open when mirador initializes (each object should at least provide a manifestId key with the value of the IIIF presentation manifest to load)
    ...
    // https://github.com/ProjectMirador/mirador/blob/master/src/state/actions/window.js#L48-L65
    // https://github.com/ProjectMirador/mirador/blob/master/src/lib/MiradorViewer.js#L53-L62
    */
  ], 
  thumbnailNavigation: {
